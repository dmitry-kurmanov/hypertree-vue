...
})(
  {
    6: [
      function(require, module, exports) {
        ...
        function app(state, actions, view, container) {
          ...
          var wiredActions = wireStateToActions(
            [],
            globalState,
            clone(actions)
          );
        ...
        var TreeNode = (exports.TreeNode = function TreeNode(_ref, children) {
          ...
          var renderHeader = function renderHeader() {
            if (config.childrenIds.length === 0)
              return (0, _hyperapp.h)("h4", null, config.text);
            if (config.isExpand)
              return (0, _hyperapp.h)("h4", null, "\u2191 ", config.text);
            return (0, _hyperapp.h)("h4", null, "\u2193 ", config.text);
          };
          ...
          return (0, _hyperapp.h)(
            ...
            renderHeader(),
            (0, _hyperapp.h)("div", { style: style }, children)
          );
        });
      },
      { hyperapp: 6 }
    ...
    2: [
      function(require, module, exports) {
        ...
        var generateMarkup = (exports.generateMarkup = function generateMarkup(
          normalizedTree,
          callAction
        ) {
          var stack = [];
          ...
          for (var nodeId in normalizedTree) {
            ...
            if (nodeConfig.parentId === "root") {
              nodeMarkup = (0, _hyperapp.h)(_TreeNode.TreeNode, {
                config: nodeConfig,
          ...
          while (stack.length > 0) {
            ...
            if (nodeConfig.childrenIds.length !== 0) {
              nodeConfig.childrenIds.forEach(function(childId) {
                ...
                childMarkup = (0, _hyperapp.h)(_TreeNode.TreeNode, {
                  config: childConfig,
                  callAction: callAction
                });
                nodeMarkup.children[1].children.push(childMarkup); //bad code

                if (childConfig.childrenIds.length !== 0)
                  stack.push(childMarkup);
              });
            }
          }
        ...
        var view = (exports.view = function view(state, actions) {
          ...
          return (0, _hyperapp.h)(
            "div",
            null,
            (0, _hyperapp.h)("h1", null, state.title),
            markup
          );
        });
        ...
        var render = (exports.render = function render(config, container) {
          ...
          var wiredActions = (0, _hyperapp.app)(
            state,
            _actions.actions,
            view,
            container
      ...
      { hyperapp: 6, "./components/TreeNode.js": 5, "./actions.js": 4 }
    ],
    10: [
      function(require, module, exports) {
